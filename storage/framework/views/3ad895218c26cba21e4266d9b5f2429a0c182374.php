...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/themes/dark-layout.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/themes/bordered-layout.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/themes/semi-dark-layout.css')); ?>">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/core/menu/menu-types/horizontal-menu.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/plugins/forms/form-validation.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/pages/page-auth.css')); ?>">
    <!-- END: Page CSS-->
...
<script src="<?php echo e(url('app-assets/vendors/js/ui/jquery.sticky.js')); ?>"></script>
<script src="<?php echo e(url('app-assets/vendors/js/forms/validation/jquery.validate.min.js')); ?>"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="<?php echo e(url('app-assets/js/scripts/pages/page-auth-login.js')); ?>"></script>
<script src="<?php echo e(url('app-assets/js/scripts/pages/page-auth-register.js')); ?>"></script>
<!-- END: Page JS-->
...
<?php /**PATH F:\app\kopasera\resources\views/layouts/app.blade.php ENDPATH**/ ?>