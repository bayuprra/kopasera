                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="<?php echo e(route('deleteKategori')); ?>" method="post"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('addKategori')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
        ...
        <div class="modal fade" id="modal-update-<?php echo e($da->id); ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('updateKategori')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($da->id); ?>">
                            <div class="row">
                                <div class="col-sm-12 row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>Kategori</label>
                                            <input type="text" class="form-control" placeholder="Masukan Kategori"
                                                name="kategori" value="<?php echo e($da->kategori); ?>">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main_layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\app\kopasera\resources\views/layout/admin_layout/kategori.blade.php ENDPATH**/ ?>